...
var Spending = React.createClass({
    propTypes: {
        fundingExpenditures: React.PropTypes.object
    },
    ...
    renderSvg: function(node) {
        ...
        function render() {
          if (this.props.dataSet.length == 0) { renderEmpty() }
          else if (this.props.chartType === 'bar') { renderBars() }
          else if (this.props.chartType === 'pie') { renderPie() }
        }
        ...
        var svg = d3.select(node).select('.d3spend')
          .append('svg')
          .attr('width', '100%');
